...
<?php } ?>
        ...
        <div class="my-3">
						...
						<input class="px-4 w-full border-2 py-2 rounded-md text-sm outline-none" type="password" name="confirm_password" placeholder="Retype your password" required="required">
							...
							<div class="">
								<button class="mt-4 mb-3 w-full bg-green-500 hover:bg-green-400 text-white py-2 rounded-md transition duration-100">Submit</button>
								
							</div>
				</form>
				<a href="index.php"><p class="mt-8"> Want to login? <span class="cursor-pointer text-sm text-blue-600"> Login</span></p></a>
			</div>
		</div>
	</div>
</div>
