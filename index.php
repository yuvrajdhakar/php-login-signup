            ...
            <div>
                ...
                <form method="post" action="login.php">
                    ...
                    <div class="flex justify-between">
                        ...
                        <a href="forgot-password.php"><span
                                    class="text-sm text-blue-700 hover:underline cursor-pointer">Forgot password?</span></a>
                    </div>
                    <div class="">
                ...
                <a href="signup.php"><p class="mt-8"> Dont have an account? <span
                                class="cursor-pointer text-sm text-blue-600"> Join free today</span></p></a>
            </div>
        </div>
    </div>
</div>
