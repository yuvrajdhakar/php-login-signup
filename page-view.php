                                                    ...
                                                    <div class="block">
                                                        ...
                                                        <div class="flex w-full items-center justify-start text-xs">
                                                            <div class="flex items-center justify-center space-x-1 px-2 font-semibold text-gray-700">
                                                                <a onclick="AddLike(<?php echo $row_comment['id']; ?>)"
                                                                   class="hover:underline">
                                                                    <small id="likes_count_<?php echo $row_comment['id']; ?>">Like
                                                                        (<?php echo $row_comment['likes']; ?>)</small>
                                                                </a>
                                                                <small class="self-center">.</small>
                                                                <a class="hover:underline reply_click_class"
                                                                   id="reply_click_<?php echo $row_comment['id']; ?>"
                                                                   onclick="showTheForm(<?php echo $row_comment['id']; ?>)">
                                                                    <small>Reply</small>
                                                                </a>
                                                                <small class="self-center">.</small>
                                                            ...
                                                            <div class="flex items-center space-x-2 space-y-2">
                                                                ...
                                                                <div class="flex items-center justify-center space-x-2">
                                                                    <div class="block">
                                                                        ...
                                                                        <div class="flex w-full items-center justify-start text-xs">
                                                                            <div class="flex items-center justify-center space-x-1 px-2 font-semibold text-gray-700">
                                                                                <a onclick="AddLike(<?php echo $row_reply_comment['id']; ?>)" class="hover:underline">
                                                                                    <small id="likes_count_<?php echo $row_reply_comment['id']; ?>">Like (<?php echo $row_reply_comment['likes']; ?>)</small>
                                                                                </a>
                                                                                <small class="self-center">.</small>
                                                                                <a href="#" class="hover:underline">
                                                                                    <small>Reply</small>
                                                        ...
                                                        <?php } ?>
                                                        <div class="hidden"
                                                             id="reply_form_<?php echo $row_comment['id']; ?>">
                                                            <form method="post" class="w-full p-4">
                                                                <input type="hidden" name="parent_id"
                                                                       value="<?php echo $row_comment['id']; ?>"/>
                                                                ...
                                                                <button type="button"
                                                                        onclick="hideTheForm(<?php echo $row_comment['id']; ?>)"
                ...
                function AddLike(id) {
                    ...
                    $.ajax({
                        ...
                        if (response.success) {
                            ...
                            $('#likes_count_' + id).html("Like (" + likes + ")");
                        } else {
