    ...
    <div class="flex justify-end">
        <div class="bg-white min-h-screen w-1/2 flex justify-center items-center">
            <div>
                ...
                <form action="api-signup-process.php" method="POST">
                    <div>
                    ...
                    <div class="mt-5">
                        ...
                        <input class="px-4 w-full border-2 py-2 rounded-md text-sm outline-none" type="text" name="name"
                ...
                <a href="index.php"><p class="mt-8"> Already have an account? <span
